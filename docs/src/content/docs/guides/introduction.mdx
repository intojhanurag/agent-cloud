...
- [Install Agent Cloud](/docs/guides/installation/) to get the CLI on your machine
- [Quick Start](/docs/guides/quickstart/) to deploy your first project in three commands
- [Configuration](/docs/guides/configuration/) to set up API keys and preferences
